...
> **NOTE:** Company Communicator now relies on the default *.azurewebsites.net hostname. If you want to use a custom domain name, read the instructions [here](Custom-domain-option).
